...
function placeXOrO(squareNumber) {
   ...
   if (!selectedSquares.some(element => element.includes(squareNumber))) {
      ...
      if (activePlayer === 'X') {
         ...
         select.style.backgroundImage = 'url("./images/X_Mark.jpg")'
      //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'      
      } else {
         //if activePlayer is equal to 'O', the o.png is placed in HTML. 
         select.style.backgroundImage = 'url("./images/O_Mark.jpg")';
      }
      ...
      audio('./media/place2.mp3'); //Audio clip from https://www.zapsplat.com/
...
function checkWinConditions() {
   ...
   //and 9 squares are selected, the code executes. 
      ...
      audio('./media/tie2.mp3');  //Audio clip from https://www.zapsplat.com/
...
function disableClick() {
   //This makes our body unclikcable. 
...
function audio(audioURL) {
   //We create a new audio object and we pass the path as a paramet. 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
   ...
   let x1 = coordX1, 
      ...
      audio('./media/winGame2.mp3');  //Audio clip from https://www.zapsplat.com/
...
function resetGame() {
   ...
   for (let i = 0; i < 9; i++) {
      ...
      //This removes our elemetns backgroundImage. 
